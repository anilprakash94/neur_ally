...
def extract_vars(gwas_file, var_dict, exon_dict):
    ...
    keywords = ['Asperger disorder', 'Autism', 'Autism spectrum disorder']
    gwas_var = set()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Outputs ASD GWAS variant coordinates to file')
    parser.add_argument('-g', '--gwas_file', default = "/home/hmg/gwas_catalog_all_v1.0", help='gwas catalog all dataset')
    parser.add_argument('-o', '--out_file', default="asd_pos_vars.txt", help='output file having asd gwas catalog SNP coordinates')
